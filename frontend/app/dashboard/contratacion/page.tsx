...
/**
 * Página del módulo Contratación
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-2">
            Gestión de procesos de contratación y onboarding
          </p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          <div className="flex-1">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Buscar procesos por candidato, cargo o empresa..."
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-12 text-center">
        <div className="max-w-md mx-auto">
          ...
          <p className="text-gray-600 mb-6">
            El módulo de contratación estará disponible próximamente. 
            Incluirá herramientas completas para gestionar todo el proceso de contratación.
          </p>
          ...
          <div className="space-y-3 text-left bg-gray-50 rounded-xl p-4">
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              ...
              <li>• Proceso de onboarding</li>
              <li>• Seguimiento post-contratación</li>
            </ul>
          </div>
        </div>
      </div>
