...
import { PiggyBank, ArrowLeft, Power, PowerOff, Download } from 'lucide-react'
...
export default function CesantiasPage() {
  ...
  const handleDownload = async () => {
    try {
      ...
      showToast('Archivo Fondos de Cesantías descargado exitosamente', 'success')
    } catch (error) {
  ...
  const handleActivateDeactivate = async () => {
    ...
    try {
      ...
      localStorage.removeItem('fondos_cesantias_cache')
      await loadData()
      showToast(`Fondo de cesantías ${newStatus ? 'activado' : 'desactivado'} exitosamente`, 'success')
      setShowActivateDeactivateModal(false)
      setSelectedRecord(null)
    } catch (error: any) {
      console.error('Error updating fondo cesantias:', error)
      showToast(error.message || 'Error al actualizar el fondo de cesantías', 'error')
    } finally {
      setUpdating(false)
    }
  }
      ...
      <div className="mb-6">
        <div className="flex items-center space-x-4 mb-4">
          ...
          <button
            ...
            title="Descargar lista de Fondos de Cesantías en formato Excel"
          >
